---
layout: post
title:  "Weeks 18: The bigger picture -- developing an ecosystem around *AskBob*"
...
This week, the prime focus on the "bigger picture" for *AskBob* in a wider context.
...
## Configuration web app improvements

This week also saw Ak make improvements to the validation of stories, names and descriptions on the configuration generator web app. An option to specify a plugin name, as well as list `spaCy` entities to be used by the model, was also added in the configuration web app to help plugin developers make their own plugin build-time configurations.
